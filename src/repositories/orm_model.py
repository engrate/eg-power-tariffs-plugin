...
class GridOperator(BaseSQLModel):
    ...
    metering_grid_areas:Mapped[list["MeteringGridArea"]]= relationship("MeteringGridArea", back_populates="grid_operator", cascade="all, delete-orphan")
...
class PowerTariff(BaseSQLModel):
    ...
    metering_grid_areas: Mapped[list["MeteringGridArea"]] = relationship(
        "MeteringGridArea",
        secondary="metering_area_x_power_tariff",
...
class MeteringGridArea(BaseSQLModel):
    ...
    grid_operator:Mapped["GridOperator"]= relationship("GridOperator", back_populates="metering_grid_areas", uselist=False)
...
class MeteringAreaByPowerTariffs(BaseSQLModel):
    __tablename__ = "metering_area_x_power_tariff"
