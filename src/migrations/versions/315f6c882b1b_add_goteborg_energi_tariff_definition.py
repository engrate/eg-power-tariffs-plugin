"""Add Goteborg Energi tariff definition

Revision ID: 315f6c882b1b
Revises: 52cb8eeee2d6
Create Date: 2025-05-22 10:58:59.869099+00:00
...
revision: str = '315f6c882b1b'
down_revision: Union[str, None] = '52cb8eeee2d6'
        ...
        [
            {
                ...
                'name': 'Standard fee',
                'model': 'avgMonthlyPeaksPowerFactor',
                'description': 'Average of the 3 highest power peaks (kW/h) multiplied by factor',
                'samples_per_month': 3,
                'time_unit': 'hourly',
        ...
        [
            {
                ...
                'fuse_from': '16A',
                'fuse_to': '63A',
                'hints': {'location': 'Göteborg', 'type': 'flat_rate'},  # Example hint
                'unit': 'kr/kw',
                'price_exc_vat': 33.75,
                'price_inc_vat': 45,
                'intervals': intervals
